<?php
abstract class Inx_Apiimpl_Core_SubscriptionLogEntryRowSetImpl_AttrGetter
{
	public $typedIndex;
	...
	public function getDateTime( $oEntry )
	{
		throw new Inx_Api_IllegalStateException( "attribute type mismatch" );
	}

	public function getTime(  $oEntry )
	{
		throw new Inx_Api_IllegalStateException( "attribute type mismatch" );
	}

	public function getString(  $oEntry )
	{
		throw new Inx_Api_IllegalStateException( "attribute type mismatch" );
	}

	public function getDouble(  $oEntry )
	{
		throw new Inx_Api_IllegalStateException( "attribute type mismatch" );
	}

	public function getDate(  $oEntry )
	{
		throw new Inx_Api_IllegalStateException( "attribute type mismatch" );
	}
